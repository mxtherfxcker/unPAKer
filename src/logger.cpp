...
namespace unpaker
{
    ...
    Logger::Logger() : dev_mode_(false), colors_enabled_(true), log_file_(nullptr)
    {
    }
            ...
            try
            {
                ...
                if (log_file_ && log_file_->is_open())
                {
                    ...
                    *log_file_ << "========================================\n";
                    ...
                    std::cout << "[INFO] Logger: Log file opened: " << log_file_path_.string()
                              << std::endl;
                }
                else
                {
                    std::cerr << "[WARNING] Logger: Failed to open log file: "
                              << log_file_path_.string() << std::endl;
                    log_file_.reset();
                }
            }
            catch (const std::exception &e)
            {
                std::cerr << "[ERROR] Logger: Exception opening log file: " << e.what()
                          << std::endl;
                log_file_.reset();
            }
        }
